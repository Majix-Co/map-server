...
os.system('curl https://raw.githubusercontent.com/Majix-Co/map-server/refs/heads/Installmain/ecryptinkey.key -o ecryptinkey.key')
shutil.move(tempvar + "\\" + "ecryptinkey.key", dir)
os.system('curl https://raw.githubusercontent.com/Majix-Co/map-server/refs/heads/Installmain/password3key.key -o password3key.key')
